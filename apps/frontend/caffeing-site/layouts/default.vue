<template>
    <div class="flex flex-col min-h-screen bg-gray-100 text-gray-800">
      ...
      <header class="bg-gray-800 text-white py-4">
        <div class="container mx-auto flex items-center justify-between px-4 sm:px-8">
          ...
          <nav class="hidden md:flex md:space-x-6">
            <ul class="flex flex-row space-x-6">
              <li>
                <NuxtLink to="/" class="block py-2 text-white hover:bg-gray-700">Home</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/about" class="block py-2 text-white hover:bg-gray-700">About</NuxtLink>
              </li>
              <li>
                <NuxtLink to="/contact" class="block py-2 text-white hover:bg-gray-700">Contact</NuxtLink>
              </li>
            </ul>
          </nav>
        ...
        <!-- Mobile Navigation -->
        <nav
          :class="[menuOpen ? 'block' : 'hidden', 'absolute top-16 left-0 w-full bg-gray-800 md:hidden']"
        >
